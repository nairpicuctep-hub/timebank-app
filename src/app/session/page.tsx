...
export default async function SessionPage() {
  ...
  const grouped = (teachers || []).reduce((acc: any, t: any) => {
  ...
  const teacherList = Object.values(grouped) as any[]
                ...
                <div className="flex items-end gap-3 w-full">
                  ...
                  <div>
                    ...
                    <div className="text-xs" style={{ color: 'rgba(255,255,255,0.7)' }}>
                      {t.profile.location || 'Worldwide'}
                    </div>
                  </div>
                  {t.profile.rating_as_teacher > 0 && (
                    <div className="ml-auto text-xs font-mono text-white">
                      ★ {Number(t.profile.rating_as_teacher).toFixed(1)}
                    </div>
                  )}
                </div>
              </div>
